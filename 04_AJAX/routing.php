...
Utils::addRoute('fluidListPart',    'FluidListCtrl',        ['admin', 'projectManager', 'engineer', 'expert']);
Utils::addRoute('fluidListFull',    'FluidListCtrl',        ['admin', 'projectManager', 'engineer', 'expert']);
